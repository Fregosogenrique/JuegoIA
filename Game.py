...
class Game:
    ...
    def calculate_optimal_path(self):
        # Calcula la ruta usando el árbol de decisiones
        # Crear un árbol de decisiones con la matriz de movimiento actual
        decision_tree = DecisionTree(self.game_state, self.movement_matrix)
    ...
    def toggle_game(self):
        ...
        if not self.is_running:
            ...
            # Si tenemos un camino inteligente, usarlo
            if GameConfig.USE_DECISION_TREE:
                decision_tree = DecisionTree(self.game_state, self.movement_matrix)
                smart_path = decision_tree.find_path(
                    self.game_state.player_pos,
                    self.game_state.house_pos
    ...
    def run(self):
        ...
        while running:
            ...
            # Controlar FPS
            clock.tick(GameConfig.GAME_SPEED)